...
-- For marketing purposes, send out a card on customers birthdays
-- Adding an index of Date of Birth will allow efficient linear searches
-- of up and coming birthdays
CREATE INDEX idx__pers_dob ON Person(dateOfBirth);
...
INSERT INTO OrderStatus VALUES ((SELECT MAX(id) + 1 FROM OrderStatus), 'Despatched');
INSERT INTO OrderStatus VALUES ((SELECT MAX(id) + 1 FROM OrderStatus), 'Paid');
COMMIT;
...
--go round the loop max_value times - value supplied by the user
	...
	, trunc(DBMS_RANDOM.VALUE(1, (SELECT MAX(id) + 1 FROM Customer)))
...
INSERT INTO Product VALUES ((SELECT MAX(id) + 1 FROM Product), 'Imbiss Kithen Worktop (Brushed Stainless Steel)', 2050.00, 'Take the Imbiss frame pieces (4 in total) and join it all together with 2 cans of wood glue. Apply remaining wood glue to the underside of the worktop and assemble');
INSERT INTO Product VALUES ((SELECT MAX(id) + 1 FROM Product), 'Kiez Sofa Set (Vintage Orange Velvet)', 1809.00, 'Take the Kiez frame pieces (all four of them), the 12 foam padding packs and the orange velvet upholstery and join it all together with 3 cans of wood glue');
COMMIT;
...
, CONSTRAINT ck__custorderline_qty CHECK (quantity > 0)
) /* added to ClusCustOrder as described above */
CLUSTER ClusCustOrder (customerOrderId);
...
--go round the loop max_value times - value supplied by the user
	FOR i IN 1..max_value LOOP
	INSERT INTO CustomerOrderLine VALUES (i + 1
								, trunc(DBMS_RANDOM.VALUE(1, (SELECT MAX(id) + 1 FROM Product)))
...
INSERT INTO StockItem VALUES ((SELECT MAX(id) + 1 FROM StockItem), 'Imbiss Frame', 0, 2, 2);
INSERT INTO StockItem VALUES ((SELECT MAX(id) + 1 FROM StockItem), 'Imbiss Worktop Piece', 0, 2, 1);
INSERT INTO StockItem VALUES ((SELECT MAX(id) + 1 FROM StockItem), 'Kiez Frame', 1, 1, 1);
INSERT INTO StockItem VALUES ((SELECT MAX(id) + 1 FROM StockItem), 'Kiez Orange Velvet Upholstery', 1, 1, 1);
COMMIT;
...
INSERT INTO ProductStockItem VALUES (3, 7, 2);
INSERT INTO ProductStockItem VALUES (3, 8, 1);
INSERT INTO ProductStockItem VALUES (3, 1, 3);
INSERT INTO ProductStockItem VALUES (4, 9, 4);
INSERT INTO ProductStockItem VALUES (4, 10, 1);
INSERT INTO ProductStockItem VALUES (4, 1, 3);
COMMIT;
...
INSERT INTO Supplier VALUES (1, 'Oak and Fold Partners', (SELECT MAX(id) FROM Address), (SELECT MAX(id) FROM Person));
INSERT INTO Supplier VALUES ((SELECT MAX(id) + 1 FROM Supplier)
, 'Wooken Legs Ltd', (SELECT MAX(id) - 1 FROM Address), (SELECT MAX(id) - 1 FROM Person));
INSERT INTO Supplier VALUES ((SELECT MAX(id) + 1 FROM Supplier)
, 'Hokem Pokem and Sons - Bits n Bobs', (SELECT MAX(id) - 2 FROM Address), (SELECT MAX(id) - 2 FROM Person));
INSERT INTO Supplier VALUES ((SELECT MAX(id) + 1 FROM Supplier)
, 'Lots Wife of Stuff', (SELECT MAX(id) - 3 FROM Address), (SELECT MAX(id) - 3 FROM Person));
INSERT INTO Supplier VALUES ((SELECT MAX(id) + 1 FROM Supplier)
, 'Hairy Marys Emprorium', (SELECT MAX(id) - 4 FROM Address), (SELECT MAX(id) - 4 FROM Person));
...
INSERT INTO StockItemSupplier VALUES (1, 3, 150.00);
INSERT INTO StockItemSupplier VALUES (1, 4, 140.00);
INSERT INTO StockItemSupplier VALUES (3, 2, 500.00);
INSERT INTO StockItemSupplier VALUES (4, 2, 510.00);
INSERT INTO StockItemSupplier VALUES (3, 3, 499.00);
INSERT INTO StockItemSupplier VALUES (4, 3, 500.00);
INSERT INTO StockItemSupplier VALUES (3, 4, 500.00);
INSERT INTO StockItemSupplier VALUES (4, 4, 510.00);
INSERT INTO StockItemSupplier VALUES (5, 3, 499.00);
INSERT INTO StockItemSupplier VALUES (6, 3, 500.00);
INSERT INTO StockItemSupplier VALUES (5, 4, 500.00);
INSERT INTO StockItemSupplier VALUES (6, 4, 510.00);
INSERT INTO StockItemSupplier VALUES (7, 3, 200.00);
INSERT INTO StockItemSupplier VALUES (7, 4, 205.00);
INSERT INTO StockItemSupplier VALUES (8, 3, 499.00);
INSERT INTO StockItemSupplier VALUES (8, 4, 500.00);
INSERT INTO StockItemSupplier VALUES (9, 5, 500.00);
INSERT INTO StockItemSupplier VALUES (10, 5, 205.00);
COMMIT;
...
--go round the loop max_value times - value supplied by the user
	...
	INTO randnor, randval FROM Dual;

	INSERT INTO PurchaseOrder VALUES (i + 1
								, (SELECT to_date('2013-01-01', 'yyyy-mm-dd') + randval FROM Dual)
								, trunc(DBMS_RANDOM.VALUE(1, (SELECT MAX(id) + 1 FROM Supplier)))
								, 1000.00
								, CASE WHEN randnor > 0 THEN 2 ELSE 1 END
								, (SELECT to_date('2013-01-20', 'yyyy-mm-dd') + randval FROM Dual)
							);
...
-- Data
-- First Row
INSERT INTO PurchaseOrderLine VALUES (1, 1, 2, 2 * (SELECT MIN(agreedPrice) FROM StockItemSupplier WHERE stockItemId = 1));
DECLARE max_value NUMBER := 80;
	randite1 NUMBER;
	randite2 NUMBER;
	randqty1 NUMBER;
...
--go round the loop max_value times - value supplied by the user
	...
	, trunc(DBMS_RANDOM.VALUE(6, 10))
	, trunc(DBMS_RANDOM.VALUE(1, 5))
	, trunc(DBMS_RANDOM.VALUE(1, 5))
	INTO randite1, randite2, randqty1, randqty2 FROM Dual;
	INSERT INTO PurchaseOrderLine VALUES (i + 1, randite1, randqty1, randqty1 * (SELECT MIN(agreedPrice) FROM StockItemSupplier WHERE stockItemId = randite1));
	INSERT INTO PurchaseOrderLine VALUES (i + 1, randite2, randqty2, randqty2 * (SELECT MIN(agreedPrice) FROM StockItemSupplier WHERE stockItemId = randite2));
  END LOOP;
-- end of script
END;
--need to enter a new line (ENTER) to make script run
...
--go round the loop max_value times - value supplied by the user
	FOR i IN 1..max_value LOOP
	SELECT trunc(DBMS_RANDOM.VALUE(-1000, 1000))
	INTO randval FROM Dual;

	INSERT INTO CashTransaction VALUES (i + 1
								, 500.00
								, (SELECT to_date('2013-01-01', 'yyyy-mm-dd') + randval FROM Dual)
								, (SELECT to_date('2013-01-03', 'yyyy-mm-dd') + randval FROM Dual)
								, (SELECT to_date('2013-01-08', 'yyyy-mm-dd') + randval FROM Dual)
								);
...
-- Data
DECLARE max_value NUMBER := 81;
--start of script
BEGIN
--go round the loop max_value times - value supplied by the user
	FOR i IN 1..max_value LOOP
	INSERT INTO Receipt VALUES (i, i);
  END LOOP;
-- end of script
END;
--need to enter a new line (ENTER) to make script run
...
-- Data
DECLARE max_value NUMBER := 20;
--start of script
BEGIN
--go round the loop max_value times - value supplied by the user
	FOR i IN 1..max_value LOOP
	INSERT INTO Payment VALUES (i + 81, i);
  END LOOP;
-- end of script
END;
--need to enter a new line (ENTER) to make script run
